...
const navigation = [
  { name: "WIP Projects", href: "#", icon: FolderIcon, current: true },
  { name: "Completed", href: "#", icon: ChartBarSquareIcon, current: false },
                      ...
                      <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        ...
                        <li className="-mx-6 mt-auto">
                          ...
                          >
                            ...
                            <span aria-hidden="true">Pineapple3D</span>
                          </a>
                        </li>
                      </ul>
                    </nav>
